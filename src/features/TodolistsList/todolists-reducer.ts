...
// export const OLDtodolistsReducer = (state: Array<TodolistDomainType> = initialState, action: ActionsType): Array<TodolistDomainType> => {
//     switch (action.type) {
...
export const addTodolistTC = (title: string) => {
    return async (dispatch: ThunkDispatch) => {
        ...
        try {
            ...
            dispatch(appAction.setAppStatusAC({status: 'idle'}))
        }
    }
}
